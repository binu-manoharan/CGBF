...
public class BoardScoreCalculatorTest {
    ...
    public void should_compute_score_based_on_number_of_disappeared_cells() throws Exception {
        ...
        assertThat("The score for column 5 is 50", boardScoreCalculator.calculateColumnScore(4), is(40));
        assertThat("The score for column 6 is 50", boardScoreCalculator.calculateColumnScore(5), is(40));
    }
